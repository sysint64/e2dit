...
//
// RGB -------------------------------------------->
void RGB_RParam() { fragColor = vec4 (vec3(Pos.y, RGB[1], RGB[2]), 1); }
void RGB_GParam() { fragColor = vec4 (vec3(RGB[0], Pos.y, RGB[2]), 1); }
void RGB_BParam() { fragColor = vec4 (vec3(RGB[0], RGB[1], Pos.y), 1); }
// <-------------------------------------------- RGB
//
void main() {
	switch (Pallete) {
